# CVE Query Script - Version 1.2.6
...
logging.basicConfig(
    ...
    level=logging.INFO,  # Set log level (INFO, WARNING, ERROR, DEBUG)
    format="%(asctime)s - %(levelname)s - %(message)s"
)

console_handler = logging.StreamHandler()
console_handler.setLevel(logging.ERROR)  # Log ERROR and above to console
...
# Function to handle multiple date formats, the NVD data seems to have changed as it matured
